        ...
        $(".latest-tweets .slider").bxSlider({
            mode:
                $this.data("mode") != "undefined"
                    ...
                    : "horizontal",
            speed:
                $this.data("speed") != "undefined" ? $this.data("speed") : 2000,
            controls:
                ($this.data("controls") != "undefined") != "undefined"
                    ? $this.data("controls")
                    : true,
            nextSelector:
                $this.data("nextselector") != "undefined"
                    ? $this.data("nextselector")
                    : "",
            prevSelector:
                $this.data("prevselector") != "undefined"
                    ? $this.data("prevselector")
                    : "",
            pager:
                $this.data("pager") != "undefined" ? $this.data("pager") : true,
            pagerSelector:
                $this.data("pagerselector") != "undefined"
                    ? $this.data("pagerselector")
                    : "",
            pagerCustom:
                $this.data("pagercustom") != "undefined"
                    ? $this.data("pagercustom")
                    : "",
            auto: $this.data("auto") != "undefined" ? $this.data("auto") : true,
            autoHover:
                $this.data("autoHover") != "undefined"
                    ? $this.data("autoHover")
                    : true,
            adaptiveHeight:
                $this.data("adaptiveheight") != "undefined"
                    ? $this.data("adaptiveheight")
                    : true,
            useCSS:
                $this.data("useCSS") != "undefined"
                    ? $this.data("useCSS")
                    : false,
