...
<head>
	...
	<link rel="apple-touch-icon" type="image/x-icon" href="{{ asset('main/img/apple-touch-icon-57x57-precomposed.png') }}">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="{{ asset('main/img/apple-touch-icon-72x72-precomposed.png') }}">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="{{ asset('main/img/apple-touch-icon-114x114-precomposed.png') }}">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="{{ asset('main/img/apple-touch-icon-144x144-precomposed.png') }}">
									...
									<div class="menu-wrapper">
										<div class="row">
											<div class="col-md-4">
												<h3>Museum Tours</h3>
												<div class="menu-item">
													<a href="#"><img src="{{ asset('main/img/menu-demo-1.jpg') }}" width="400" height="226" alt="" class="img-responsive">
													</a>
													<p>
											...
											<div class="col-md-4">
												...
												<div class="menu-item">
													<a href="#"><img src="{{ asset('main/img/menu-demo-2.jpg') }}" width="400" height="226" alt="" class="img-responsive">
													</a>
													<p>
														Lorem ipsum dolor sit amet, et cum civibus referrentur, at propriae forensibus qui. Duo aliquip necessitatibus ne.
													</p>
											...
											<div class="col-md-4">
												<h3>Travel Tours</h3>
												<div class="menu-item">
													<a href="#"><img src="{{ asset('main/img/menu-demo-3.jpg') }}" width="400" height="226" alt="" class="img-responsive">
													</a>
													<p>
														Lorem ipsum dolor sit amet, et cum civibus referrentur, at propriae forensibus qui. Duo aliquip necessitatibus ne.
													</p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<h3>Twitter feed</h3>
					<div class="latest-tweets" data-number="10" data-username="mrlowlander" data-mode="fade" data-pager="false" data-nextselector=".tweets-next" data-prevselector=".tweets-prev" data-adaptiveheight="true">
				...
				<div class="col-md-3 col-sm-12">
					...
					<form method="post" action="{{ asset('main/assets/newsletter.php') }}" name="newsletter_2" id="newsletter_2">
...
>>>>>>> cb7e396536e69df07e5a5074b93d8235f7e00c6c
