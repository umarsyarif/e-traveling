                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-right">
                                <button type="button" class="btn btn-primary btn-sm waves-effect waves-light mr-2" data-toggle="modal" data-target="#modal-create">+ Wisata</button>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-primary row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" data-a-sign="Rp. " id="price" name="price" class="form-control autonumber @error('price') is-invalid @enderror" value="{{ old('price') }}" required>
                        </div>
                        <div class="col-sm-6">
                            <label for="name">Kuota</label>
                            <input type="number" min="1" id="kuota" name="kuota" class="form-control @error('kuota') is-invalid @enderror" value="{{ old('kuota') }}" required>
                        </div>
                    </div>
                    <div class="form-group form-primary">
